...
$string['remuicourseimage'] = 'Course format image';
$string['remuicourseimage_help'] = 'This image will be displayed in General section card in card layout and as a background of General section in list layout.';
