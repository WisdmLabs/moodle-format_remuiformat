...
/**
 * Remui Format - A format that uses a card and list layout.
 *
 * @package    format_remuiformat
 * @version    See the value of '$plugin->version' in version.php.
 * @copyright  &copy; 2019 WisdmLabs in respect to modifications of standard topics format.
 * @author     WisdmLabs
 ...
 * @access       public
 */
class MoodleQuickForm_rfcolourpopup extends HTML_QuickForm_text implements templatable {
     ...
     */
    public function MoodleQuickForm_rfcolourpopup($elementName = null, $elementLabel = null, $attributes = null, $options = null) {
    ...
    public function toHtml() {
        ...
        $PAGE->requires->js('/course/format/remuiformat/js/rf_colourpopup.js');
        $PAGE->requires->js_init_call('M.util.init_rfcolour_popup', array($id));
