...
namespace format_remuiformat\output\local\content\cm;
...
/**
 * RemUI format completion class to render course module completion.
 *
 * @package   format_remuiformat
 * @copyright 2023 WisdmLabs
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class completion implements named_templatable {
    ...
    /** @var bool if the button is rendered small */
    protected $smallbutton = true;
     ...
     *
     * @param bool $smallbutton if the button is rendered small
     */
    ...
    public function export_for_template(\renderer_base $output): ?stdClass {
        ...
        // Always add completion dialog for RemUI format
