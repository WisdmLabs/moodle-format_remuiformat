...
'https://docs.moodle.org/36/en/Step-by-step_Installation_Guide_for_Ubuntu'.
...
2. Put Moodle in 'Maintenance Mode' (https://docs.moodle.org/36/en/Maintenance_mode) so that there are no
